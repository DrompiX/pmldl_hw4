...
from dataset_custom import TranslationDataset
...
def main(**kwargs):
    ...
    train_dataset = TranslationDataset(project_path + '/data_enru/processed/en/train.pkl',
                                            project_path + '/data_enru/processed/ru/train.pkl',
                                            kwargs['num_tokens'], kwargs['max_seq_length'])
    train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=4, pin_memory=True)
    valid_dataset = TranslationDataset(project_path + '/data_enru/processed/en/val.pkl',
                                            project_path + '/data_enru/processed/ru/val.pkl',
                                            kwargs['num_tokens'], kwargs['max_seq_length'])
    valid_loader = DataLoader(valid_dataset, batch_size=1, shuffle=True, num_workers=4, pin_memory=True)
